  ...
  return (
    ...
    >
      ...
      <View style={[styles.header, { paddingTop: insets.top + 8 }]}>
        ...
        <Text style={[styles.headerTitle, { color: theme.colors.text.primary }]}>Add Category</Text>
        <Text style={[styles.headerSubtitle, { color: theme.colors.text.secondary }]}>Create a new category</Text>
      </View>
